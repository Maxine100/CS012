...
class Distance {
	...
	public:
		...
		/* Constructs a default Distance of 0 (o feet and 0.0 inches)
		*/
		Distance();


		/* Constructs a distance of ft feet and in inches,
			unless in >= 12, in which case th evalues of feet and inches
			are adjusted accordingly. A Distance will always be positive.
		*/
		Distance(unsigned ft, double in);
		
		
		/* Constructs a disstance of 0 ft and in inches,
